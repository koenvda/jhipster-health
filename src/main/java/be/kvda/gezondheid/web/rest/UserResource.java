package be.kvda.gezondheid.web.rest;

import com.codahale.metrics.annotation.Timed;
import be.kvda.gezondheid.domain.Authority;
import be.kvda.gezondheid.domain.User;
import be.kvda.gezondheid.repository.AuthorityRepository;
import be.kvda.gezondheid.repository.UserRepository;
import be.kvda.gezondheid.repository.search.UserSearchRepository;
import be.kvda.gezondheid.security.AuthoritiesConstants;
import be.kvda.gezondheid.service.MailService;
import be.kvda.gezondheid.service.UserService;
import be.kvda.gezondheid.web.rest.dto.ManagedUserDTO;
import be.kvda.gezondheid.web.rest.dto.UserDTO;
import be.kvda.gezondheid.web.rest.util.HeaderUtil;
import be.kvda.gezondheid.web.rest.util.PaginationUtil;
