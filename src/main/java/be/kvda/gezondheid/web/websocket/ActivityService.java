package be.kvda.gezondheid.web.websocket;

import be.kvda.gezondheid.security.SecurityUtils;
import be.kvda.gezondheid.web.websocket.dto.ActivityDTO;
...
import static be.kvda.gezondheid.config.WebsocketConfiguration.IP_ADDRESS;
