...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "gezondheid@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "gezondheid API";

        private String description = "gezondheid API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "gezondheid";
